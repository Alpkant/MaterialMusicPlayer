        ...
        repeat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (sharedPreferenceSingleton.getSavedBoolean(MainActivity.this, "Repeat")) {
                    ...
                    //DrawableCompat.setTint(repeat.getDrawable(), ContextCompat.getColor(com.alperenkantarci.materialmusicplayer.Activities.MainActivity.this, R.color.colorBlack));
                } else {
                    ...
                    // DrawableCompat.setTint(repeat.getDrawable(), ContextCompat.getColor(com.alperenkantarci.materialmusicplayer.Activities.MainActivity.this, R.color.colorAccent));
                }
            }
        });
